...
class RodentSeeder extends Seeder
{
    ...
    public $rodents = [
        ...
        [ 'rodent_id' => 7, 'name' => 'Glodar 7',   'excavation_field_id' => 1, 'rodent_type_id' => 5 ],
        [ 'rodent_id' => 8, 'name' => 'Glodar 8',   'excavation_field_id' => 3, 'rodent_type_id' => 5 ],
        [ 'rodent_id' => 9, 'name' => 'Glodar 9',   'excavation_field_id' => 3, 'rodent_type_id' => 8 ],
