...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Dashboard.vue",
  components: {
    pieCard: _Card__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      memory: null,
  ...
  methods: {
    ...
    fetch: function fetch() {
      _services_ApiService__WEBPACK_IMPORTED_MODULE_0__["default"].getServerUsageData().then(this.onSuccess)["catch"](function (e) {
        console.dir(e);
