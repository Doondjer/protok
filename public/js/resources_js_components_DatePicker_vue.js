(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_DatePicker_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    apiService: _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  methods: {
    exportXls: function exportXls() {
      var _this = this;

      _services_ApiService__WEBPACK_IMPORTED_MODULE_2__["default"].exportExcel(this.form).then(function (response) {
        var fileURL = window.URL.createObjectURL(new Blob([response.data]));
        var fileLink = document.createElement('a');
        fileLink.href = fileURL;
        fileLink.setAttribute('download', "protok_".concat(_this.station.name, ".xlsx"));
      ...
      _c(
        "button",
        {
          ...
          on: {
            click: function ($event) {
              $event.preventDefault()
              return _vm.exportXls.apply(null, arguments)
            },
          },
        },
        [_vm._v("Eksportuj")]
