...
return [
    'site' => [
        ...
        'multiday_max_days'     => 'Maksimalni broj dana za koji će biti prikazani protoci u serijskom Chartu.',
        'multiday_default_days' => 'Podrazumevani broj dana za koji će biti prikazani protoci u serijskom Chartu. Aktivira se pri učitavanju stranice i kada se pređe preko maksimalno dozvoljenog broja redova',
    ],
  /*  'panel' => [
        'section:name'      => 'Podesavanje Panela',
        'panel_resources' => 'Objekti za koje ce biti prikazani protoci',
        'panel_column_size' => '',
        'panel_multiplier' => '',
